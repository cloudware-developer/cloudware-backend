        ...
        public static object ToUpperFields(this object value)
        {
            try
            {
                ...
                foreach (var propertyInfo in properties)
                {
                    ...
                    {
                        var newValue = propertyInfo.GetValue(value).ToString();
                    ...
                    else if (propertyInfo.Name == "Senha" || propertyInfo.Name == "Password" || propertyInfo.Name == "Authorization" || propertyInfo.Name == "Token")
                    {
                        var newValue = propertyInfo.GetValue(value).ToString();
            ...
            {
                throw new Exception($"Erro ao executar o método {nameof(ToUpper)}. Erro {ex.Message}");
            }
        }
